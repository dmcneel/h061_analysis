...
// Wed Apr 25 20:47:30 2018 by ROOT version 5.34/36
// from TTree tree/tree
// found on file: ../root_data/run302.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           RunNum;
   Int_t           NumHits;
   Short_t         id[76];   //[NumHits]
   UShort_t        tpe[76];   //[NumHits]
   UShort_t        tid[76];   //[NumHits]
   UShort_t        chan_id[76];   //[NumHits]
   UShort_t        board_id[76];   //[NumHits]
   UShort_t        geo_addr[76];   //[NumHits]
   UShort_t        packet_length[76];   //[NumHits]
   UShort_t        header_type[76];   //[NumHits]
   UShort_t        event_type[76];   //[NumHits]
   UShort_t        header_length[76];   //[NumHits]
   ULong64_t       event_timestamp[76];   //[NumHits]
   ULong64_t       last_disc_timestamp[76];   //[NumHits]
   ULong64_t       peak_timestamp[76];   //[NumHits]
   UShort_t        timestamp_match_flag[76];   //[NumHits]
   UShort_t        external_disc_flag[76];   //[NumHits]
   UShort_t        cfd_valid_flag[76];   //[NumHits]
   UShort_t        pileup_only_flag[76];   //[NumHits]
   UShort_t        offset_flag[76];   //[NumHits]
   UShort_t        sync_error_flag[76];   //[NumHits]
   UShort_t        general_error_flag[76];   //[NumHits]
   UShort_t        peak_valid_flag[76];   //[NumHits]
   UShort_t        pileup_flag[76];   //[NumHits]
   Int_t           sampled_baseline[76];   //[NumHits]
   Int_t           cfd_sample_0[76];   //[NumHits]
   Int_t           cfd_sample_1[76];   //[NumHits]
   Int_t           cfd_sample_2[76];   //[NumHits]
   Int_t           pre_rise_energy[76];   //[NumHits]
   Int_t           post_rise_energy[76];   //[NumHits]
   UShort_t        m1_begin_sample[76];   //[NumHits]
   UShort_t        m1_end_sample[76];   //[NumHits]
   UShort_t        m2_begin_sample[76];   //[NumHits]
   UShort_t        m2_end_sample[76];   //[NumHits]
   UShort_t        peak_sample[76];   //[NumHits]
   UShort_t        base_sample[76];   //[NumHits]
   Int_t           baseline[76];   //[NumHits]
   UShort_t        trace_length[76];   //[NumHits]
   Short_t         trace[76][1024];   //[NumHits]
