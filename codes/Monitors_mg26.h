...
#ifndef Monitors_mg26_h
#define Monitors_mg26_h
...
class Monitors_mg26 : public TSelector {
public :
   ...
   TBranch        *b_EnergyTimestampCorrection; //new
   TBranch        *b_XF;   //!
   ...
   TBranch        *b_RDTTimestampCorrection;//new
   TBranch        *b_TAC;   //!
   ...
   Monitors_mg26(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Monitors_mg26() { }
   ...
   ClassDef(Monitors_mg26,0);
};

#endif

#ifdef Monitors_mg26_cxx
void Monitors_mg26::Init(TTree *tree)
{
